...
export class NetApi {
  ...
  static HANJU: string = '/list-select-id-1-type--area--year--star--state--order-addtime-p-1.html'
  static DIANYIN: string = '/list-select-id-2-type--area--year--star--state--order-addtime-p-1.html'
  static ZONGYI: string = '/list-select-id-3-type--area--year--star--state--order-addtime-p-1.html'
  //返回拼接好的url地址
